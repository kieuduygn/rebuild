...
<ul class="nav nav-tabs">
    <li class="active"><a href="#tab1" data-toggle="tab"><strong><?php echo lang('blog:content_label') ?></strong></a></li>
    <li><a href="#tab2" data-toggle="tab"><strong><?php echo lang('global:custom_fields') ?></strong></a></li>
    <li><a href="#tab3" data-toggle="tab"><strong><?php echo lang('blog:options_label') ?></strong></a></li>
</ul>
    ...
    <div class="tab-pane active" id="tab1">
        <form class="form-horizontal form-bordered">
            <div class="form-group">
                <label class="col-sm-4 col-md-2 control-label"><?php echo lang('global:title') ?> <span class="text-danger">*</span></label>
            ...
            <div class="form-group">
                <label class="col-sm-4 col-md-2 control-label"><?php echo lang('global:slug') ?> <span class="text-danger">*</span></label>
                <div class="col-sm-8 col-md-10">
                    <?php echo form_input('slug', $post->slug, 'maxlength="100" class="form-control"') ?>
                </div>
            </div><!-- form-group -->
            <div class="form-group">
                <label class="col-sm-4 col-md-2 control-label"><?php echo lang('blog:status_label') ?><span class="text-danger">*</span></label>
                <div class="col-sm-4 col-md-4">
                    <?php echo form_dropdown('status', array('draft' => lang('blog:draft_label'), 'live' => lang('blog:live_label')), $post->status, 'id="select-templatin" style="width:300px"') ?>
                </div>
            </div><!-- form-group -->
            
            <div class="form-group">
                <label class="col-sm-4 col-md-2 control-label"><?php echo lang('blog:content_label') ?><span class="text-danger">*</span></label>
                <div class="col-sm-8 col-md-10">
                    <?php echo form_dropdown('status', array('draft' => lang('blog:draft_label'), 'live' => lang('blog:live_label')), $post->status, 'id="select-templatin" style="width:300px"') ?>
                </div>
            </div><!-- form-group -->
...
<section class="item">
    <div class="content">
                    ...
                    <ul>
                        ...
                        <?php else: ?>
                            <li>
                                ...
                                <div class="input">
                                    <?php
                                    echo form_dropdown('comments_enabled', array(
                                        'no' => lang('global:no'),
        ...
        <input type="hidden" name="row_edit_id" value="<?php
        if ($this->method != 'create'): echo $post->id;
        endif;
        ?>" />
