...
Source Database       : atrip_rebuild

Target Server Type    : MYSQL
Target Server Version : 50508
File Encoding         : 65001

Date: 2015-05-29 17:37:05
*/
...
-- ----------------------------
INSERT INTO `core_sites` VALUES ('1', 'Default Site', 'default', 'localhost', '1', '1432886175', '0');
...
-- ----------------------------
INSERT INTO `core_users` VALUES ('1', 'kieuduy.hg@gmail.com', 'cd80abd9711294402be5fcd76e01c6849801b0bc', '09e61', '1', '', '1', '', '1432886175', '1432886175', 'admin', null, null);
...
-- ----------------------------
INSERT INTO `default_ci_sessions` VALUES ('3f3d14840174a97ef3495a5a07afa9a6', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/43.0.2357.81 Safari/537.36', '1432888067', 'a:6:{s:8:\"username\";s:5:\"admin\";s:5:\"email\";s:20:\"kieuduy.hg@gmail.com\";s:2:\"id\";s:1:\"1\";s:7:\"user_id\";s:1:\"1\";s:8:\"group_id\";s:1:\"1\";s:5:\"group\";s:5:\"admin\";}');
...
-- ----------------------------
INSERT INTO `default_def_page_fields` VALUES ('1', '2015-05-29 09:56:21', null, '1', null, '<p>Welcome to our homepage. We have not quite finished setting up our website yet, but please add us to your bookmarks and come back soon.</p>');
INSERT INTO `default_def_page_fields` VALUES ('2', '2015-05-29 09:56:21', null, '1', null, '<p>To contact us please fill out the form below.</p>\n				{{ contact:form name=\"text|required\" email=\"text|required|valid_email\" subject=\"dropdown|Support|Sales|Feedback|Other\" message=\"textarea\" attachment=\"file|zip\" }}\n					<div><label for=\"name\">Name:</label>{{ name }}</div>\n					<div><label for=\"email\">Email:</label>{{ email }}</div>\n					<div><label for=\"subject\">Subject:</label>{{ subject }}</div>\n					<div><label for=\"message\">Message:</label>{{ message }}</div>\n					<div><label for=\"attachment\">Attach  a zip file:</label>{{ attachment }}</div>\n				{{ /contact:form }}');
INSERT INTO `default_def_page_fields` VALUES ('3', '2015-05-29 09:56:21', null, '1', null, '{{ search:form class=\"search-form\" }} \n		<input name=\"q\" placeholder=\"Search terms...\" />\n	{{ /search:form }}');
INSERT INTO `default_def_page_fields` VALUES ('4', '2015-05-29 09:56:21', null, '1', null, '{{ search:form class=\"search-form\" }} \n		<input name=\"q\" placeholder=\"Search terms...\" />\n	{{ /search:form }}\n\n{{ search:results }}\n\n	{{ total }} results for \"{{ query }}\".\n\n	<hr />\n\n	{{ entries }}\n\n		<article>\n			<h4>{{ singular }}: <a href=\"{{ url }}\">{{ title }}</a></h4>\n			<p>{{ description }}</p>\n		</article>\n\n	{{ /entries }}\n\n        {{ pagination }}\n\n{{ /search:results }}');
INSERT INTO `default_def_page_fields` VALUES ('5', '2015-05-29 09:56:21', null, '1', null, '<p>We cannot find the page you are looking for, please click <a title=\"Home\" href=\"{{ pages:url id=\'1\' }}\">here</a> to go to the homepage.</p>');
...
INSERT INTO `default_groups` VALUES ('3', 'bien-tap-vien', 'Biên tập viên');
...
-- ----------------------------
INSERT INTO `default_pages` VALUES ('1', 'home', '', 'Home', 'home', '0', '1', '1', null, null, null, '', null, null, null, '0', '0', 'live', '1432886182', '0', '', '1', '1', '1432886182');
INSERT INTO `default_pages` VALUES ('2', 'contact', '', 'Contact', 'contact', '0', '1', '2', null, null, null, '', null, null, null, '0', '0', 'live', '1432886182', '0', '', '0', '1', '1432886182');
INSERT INTO `default_pages` VALUES ('3', 'search', '', 'Search', 'search', '0', '1', '3', null, null, null, '', null, null, null, '0', '0', 'live', '1432886182', '0', '', '0', '1', '1432886182');
INSERT INTO `default_pages` VALUES ('4', 'results', '', 'Results', 'search/results', '3', '1', '4', null, null, null, '', null, null, null, '0', '0', 'live', '1432886182', '0', '', '0', '0', '1432886182');
INSERT INTO `default_pages` VALUES ('5', '404', '', 'Page missing', '404', '0', '1', '5', null, null, null, '', null, null, null, '0', '0', 'live', '1432886182', '0', '', '0', '1', '1432886182');
...
-- ----------------------------
INSERT INTO `default_profiles` VALUES ('1', null, null, null, null, '1', 'Site Admin', 'Site', 'Admin', '', 'en', null, null, null, null, null, null, null, null, null, null, null);
...
INSERT INTO `default_settings` VALUES ('contact_email', 'Contact E-mail', 'All e-mails from users, guests and the site will go to this e-mail address.', 'text', 'kieuduy.hg@gmail.com', '', '', '1', '1', 'email', '979');
...
-- ----------------------------
INSERT INTO `default_users` VALUES ('1', 'kieuduy.hg@gmail.com', 'cd80abd9711294402be5fcd76e01c6849801b0bc', '09e61', '1', '', '1', '', '1432886175', '1432885357', 'admin', null, '0bf5dee9fa57b108bd42aa5a87f5ab2641df0937');
